...
const STRINGS = {
  en: {
    ...
    offline: 'No connection to the game. Check your network and try again.',
  ...
  ru: {
    ...
    offline: 'Нет связи с игрой. Проверь сеть и попробуй ещё раз.',
  ...
  ua: {
    ...
    offline: 'Немає звʼязку з грою. Перевір мережу і спробуй ще раз.',
