...
const STRINGS = {
  en: {
    ...
    'hs.back': 'Back',
    'hs.loading': 'Loading...',
    'hs.nohelp': 'No such help article.',
    'hs.noreply': 'The server did not answer. Type %s in the command line.',
    'hs.t.quest': 'Quests',
    'hs.t.affects': 'Affects on you',
    'hs.legend': 'Legend',
    'hs.stats.how': 'How stats work',
    'hs.stats.base': 'your six stats. The first number is what you trained, the one in brackets is the current value with magic and gear.',
    'hs.stats.hit': 'accuracy (hitroll). The higher it is, the less often you miss.',
    'hs.stats.dam': 'damage (damroll). The higher it is, the harder you hit.',
    'hs.stats.ac': 'armor class against piercing blows. Lower is better.',
    'hs.stats.save': 'spell defence (saves vs spell). Lower is better.',
    'hs.stats.sum1': 'Training raises a stat up to a maximum set by your race and class. For humans it is 20 for every stat except charisma.',
    'hs.stats.sum2': 'While a stat is below its maximum, magic and gear can raise it for a while.',
    'hs.stats.sum3': 'Rebirth adds to the maximum, but not above 25. Only a high racial bonus goes further.',
    'hs.full': 'Read the full article',
    // location panel
    ...
    'cfg.copy': 'copy',
    'cfg.copied': 'copied',
    'cfg.refused': 'the game would not take that',
  ...
  ru: {
    ...
    'hs.back': 'Назад',
    'hs.loading': 'Загрузка...',
    'hs.nohelp': 'Такой статьи нет.',
    'hs.noreply': 'Сервер не ответил. Набери %s в командной строке.',
    'hs.t.quest': 'Задания',
    'hs.t.affects': 'Воздействия на тебе',
    'hs.legend': 'Легенда',
    'hs.stats.how': 'Как работают параметры',
    'hs.stats.base': 'шесть основных параметров. Первое число показывает, сколько натренировано, в скобках текущее значение с магией и вещами.',
    'hs.stats.hit': 'точность (hitroll). Чем выше, тем реже промахиваешься.',
    'hs.stats.dam': 'урон (damroll). Чем выше, тем сильнее бьешь.',
    'hs.stats.ac': 'класс брони против колющих ударов. Чем ниже, тем лучше.',
    'hs.stats.save': 'защита от заклинаний (saves). Чем ниже, тем лучше.',
    'hs.stats.sum1': 'Тренировки поднимают параметр до максимума, который зависит от расы и класса. У людей это 20 для всех параметров, кроме обаяния.',
    'hs.stats.sum2': 'Пока параметр не натренирован до максимума, магия и вещи могут временно его поднять.',
    'hs.stats.sum3': 'Перерождение добавляет к максимуму, но не выше 25. Выше поднимает только большой бонус расы.',
    'hs.full': 'Читать статью целиком',
    ...
    'cfg.refused': 'игра не приняла это значение',
  ...
  ua: {
    ...
    'hs.close': 'Закрити',
    'hs.back': 'Назад',
    'hs.loading': 'Завантаження...',
    'hs.nohelp': 'Такої статті немає.',
    'hs.noreply': 'Сервер не відповів. Набери %s у командному рядку.',
    'hs.t.quest': 'Завдання',
    'hs.t.affects': 'Впливи на тебе',
    'hs.legend': 'Легенда',
    'hs.stats.how': 'Як працюють параметри',
    'hs.stats.base': 'шість основних параметрів. Перше число показує, скільки натреновано, у дужках поточне значення з магією і речами.',
    'hs.stats.hit': 'влучність (hitroll). Що вища, то рідше мажеш.',
    'hs.stats.dam': 'шкода (damroll). Що вища, то сильніше бʼєш.',
    'hs.stats.ac': 'клас броні проти колючих ударів. Що нижчий, то краще.',
    'hs.stats.save': 'захист від закликань (saves). Що нижчий, то краще.',
    'hs.stats.sum1': 'Тренування піднімають параметр до максимуму, що залежить від раси й класу. У людей це 20 для всіх параметрів, крім чарівності.',
    'hs.stats.sum2': 'Поки параметр не натреновано до максимуму, магія й речі можуть тимчасово його підняти.',
    'hs.stats.sum3': 'Переродження додає до максимуму, але не вище 25. Вище піднімає тільки великий бонус раси.',
    'hs.full': 'Читати статтю повністю',
    ...
    'cfg.refused': 'гра не прийняла це значення',
